...
<script src="${rc.contextPath}/statics/libs/jquery-1.10.2.min.js"></script>
...
<script src="${rc.contextPath}/common/js/whole/monitor.js"></script>
<!--样式-->
<link rel="stylesheet" href="${rc.contextPath}/common/css/cyStyle.css">
<link rel="stylesheet" href="${rc.contextPath}/common/css/cyType.css">
<link rel="stylesheet" href="${rc.contextPath}/common/css/yfdc.css">
<link rel="stylesheet" href="${rc.contextPath}/common/css/public.css">
<!--日期-->
